              ...
              <div className={classes.cards}>
                ...
                <Card className={classes.card}>
                  ...
                  <div className={classes["lower-section"]}>
                    ...
                    <p className={classes.value}>{data.totalRevColl?.lastmonth.value}</p>
                    <p className={classes.label}>{data.totalRevColl?.lastmonth.label}</p>
                  </div>
                </Card>
                ...
                <Card className={classes.card}>
                  ...
                  <div className={classes["lower-section"]}>
                    ...
                    <p className={classes.value}>{data.totalRemSent?.lastmonth.value}</p>
                    <p className={classes.label}>{data.totalRemSent?.lastmonth.label}</p>
                  </div>
                </Card>
                ...
                <Card className={classes.card}>
                  ...
                  <div className={classes["lower-section"]}>
                    ...
                    <p className={classes.value}>{data.remittanceRate?.lastmonth.value}</p>
                    <p className={classes.label}>{data.remittanceRate?.lastmonth.label}</p>
                  </div>
                </Card>
